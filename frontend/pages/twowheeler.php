...
<style>
    <?php include "../assets/css/twowheeler.css" ?>
</style>
    <div class="main">
        <div class="slider">
            <img src="../assets/images/bikeslider.jpg" height="300" width="100%" >

        </div>
        <h1 class="avfw">Available Two Wheeler Vehicles</h1>
        ...
        <div class="productdisplay" style="overflow-y: scroll;">
            ...
            include "../../backend/functions/showtwowheeler.php";
